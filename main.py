...
for seccion in secciones:
    ...
    if seccion in ["P01", "P02", "P03"]:
        ax[0].plot(diag_0["M3"], diag_0["P"], "--", color="r" if seccion == "P01" else "b", label=seccion, lw=2)
        ax[1].plot(diag_90["M2"], diag_90["P"], "--", color="r" if seccion == "P01" else "b", label=seccion, lw=2)
    else:
